...
<qgis version="3.40.8-Bratislava" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08" autoRefreshMode="Disabled" autoRefreshTime="0" styleCategories="AllStyleCategories">
  <flags>
  ...
  <elevation mode="RepresentsElevationSurface" zscale="1" band="1" symbology="Line" zoffset="0" enabled="0">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" name="" frame_rate="10" type="line" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer locked="0" id="{e0a35bd7-82dd-4afa-8a3e-9177b3cb18ed}" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" name="" frame_rate="10" type="fill" alpha="1" force_rhr="0" is_animated="0">
        ...
        <layer locked="0" id="{7c358f26-58f0-4f4e-891e-24f3f5fc7738}" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
  ...
  <customproperties>
    <Option type="Map">
      ...
      <Option name="QFieldSync/tracking_erroneous_distance_safeguard_maximum_meters" value="100" type="int"/>
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" band="1" nodataColor="" type="paletted" alphaBand="-1">
      ...
      <colorPalette>
        <paletteEntry value="0" label="Others" color="#fffbfb" alpha="255"/>
        <paletteEntry value="1" label="Cropland - Shrubland" color="#c519f0" alpha="255"/>
        <paletteEntry value="2" label="Cropland - Built-up" color="#dc1010" alpha="255"/>
        <paletteEntry value="3" label="Shrubland - Built-up" color="#ffde47" alpha="255"/>
        <paletteEntry value="4" label="Built-up - Shrubland" color="#12edf9" alpha="255"/>
      </colorPalette>
    ...
    <huesaturation invertColors="0" colorizeStrength="100" colorizeBlue="128" colorizeRed="255" colorizeGreen="128" saturation="0" grayscaleMode="0" colorizeOn="0"/>
