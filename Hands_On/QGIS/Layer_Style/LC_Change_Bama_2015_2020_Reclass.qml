...
<qgis minScale="1e+08" version="3.40.8-Bratislava" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" autoRefreshMode="Disabled" autoRefreshTime="0" maxScale="0">
  <flags>
  ...
  <elevation mode="RepresentsElevationSurface" enabled="0" band="1" symbology="Line" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol name="" type="line" frame_rate="10" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer id="{9b754c43-6b9f-4dd3-8028-bd9f01a546fe}" locked="0" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" type="fill" frame_rate="10" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer id="{1b4a211b-c10e-4e6b-b426-560e51dacfa6}" locked="0" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer type="paletted" opacity="1" alphaBand="-1" band="1" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry value="0" alpha="255" color="#fffbfb" label="Others"/>
        <paletteEntry value="1" alpha="255" color="#c519f0" label="Cropland - Shrubland"/>
        <paletteEntry value="2" alpha="255" color="#dc1010" label="Cropland - Built-up"/>
        <paletteEntry value="3" alpha="255" color="#ffde47" label="Shrubland - Built-up"/>
        <paletteEntry value="4" alpha="255" color="#12edf9" label="Built-up - Shrubland"/>
      </colorPalette>
    ...
    <huesaturation colorizeRed="255" colorizeBlue="128" invertColors="0" colorizeStrength="100" saturation="0" colorizeGreen="128" colorizeOn="0" grayscaleMode="0"/>
